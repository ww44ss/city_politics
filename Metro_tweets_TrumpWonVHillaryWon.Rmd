...
```{r echo = FALSE, fig.align='center'}
    ...
    map = get_googlemap(center =  c(lon = -95.58, lat = 36.83),
            ...
            maptype="roadmap", color = "bw", alpha = 0.1 ) #, key = my.secret.key)
    map.plot <- ggmap(map)
...
print(xtable(head(analyzed_df[order(analyzed_df$tweet.flux, decreasing = TRUE),], min(15, nrow(analyzed_df)))), type="html", include.rownames=FALSE, include.colnames = TRUE)
```
...
```{r, results='asis'}
print(xtable(head(analyzed_df[order(analyzed_df$n.tweets, decreasing = TRUE),], min(15, nrow(analyzed_df)))), type="html", include.rownames=FALSE, include.colnames = TRUE)
```
